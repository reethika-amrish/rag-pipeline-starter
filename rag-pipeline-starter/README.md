...
> *"Deployed RAG-driven document intelligence platform using LangChain/LangGraph orchestration with AWS Textract OCR, automated chunking, vector embedding, and parallel node execution for concurrent document retrieval and CRM enrichment."*
